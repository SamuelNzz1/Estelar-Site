...
export const FunctionsSection = () => {
  ...
  return <section ref={constraintsRef} id="functions-section" className="function-section">
      ...
      <motion.h1 initial = {{opacity: 0, scale: 0.5}} transition={{duration: 1}} whileInView = {{opacity: 1, scale: 1}} className="functions-title">Funcionalidades</motion.h1>
      <motion.p initial = {{opacity: 0, scale: 0.5}} transition={{duration: 1}}  whileInView = {{opacity: 1, scale: 1}} className="functions-paragrafo">Visando alcançar o objetivo de maneira eficaz, para melhorar o seu desempenho acadêmico e olímpico, o Estelar oferece:</motion.p> 
